...
<header>
	...
	# Patient webpage
	else if ($menu == 10) { include("pacijenti.php"); }
	
	# Covid webpage
	else if ($menu == 11) { include("covid.php"); }
	
	# Review webpage
	else if ($menu == 12) { include("recenzije.php"); }
	
	print '
	</main>
	<footer>
	<p>Copyright &copy; 2023 Antonio Starinec. <a href="https://github.com/Toni1803?tab=repositories"><img src="GitHub-Mark.png" title="Github" alt="Github"></a></p>
<body/>
</html>';
?>